...
import 'package:uit_buddy_mobile/features/onboarding/data/models/forget_password_request_model.dart';
import 'package:uit_buddy_mobile/features/onboarding/data/models/moodle_token_model.dart';
import 'package:uit_buddy_mobile/features/onboarding/data/models/reset_password_request_model.dart';
import 'package:uit_buddy_mobile/features/onboarding/data/models/signin_request_model.dart';
...
class AuthRemoteDatasourceImpl implements AuthRemoteDatasource {
  ...
  Future<ApiResponse<void>> forgetPassword({required String mssv}) async {
    final response = await _dio.post<Map<String, dynamic>>(
      ...
      data: ForgetPasswordRequestModel(mssv: mssv).toJson(),
    );
