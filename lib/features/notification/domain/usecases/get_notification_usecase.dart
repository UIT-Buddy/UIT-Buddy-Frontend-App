...
class GetNotificationUsecase
    implements UseCase<PagedResult<NotificationEntity>, NotificationParams> {
  ...
  ) async => _notificationRepository.getNotifications(
...
class NotificationParams extends Equatable {
  ...
  const NotificationParams({this.cursor, this.limit = 10});
