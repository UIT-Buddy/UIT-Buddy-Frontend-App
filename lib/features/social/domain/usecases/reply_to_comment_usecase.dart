...
class ReplyToCommentUsecase implements UseCase<Unit, ReplyToCommentParams> {
  ...
  @override
  Future<Either<Failure, Unit>> call(ReplyToCommentParams params) => _repository
      .replyToComment(commentId: params.commentId, content: params.content);
}
...
class ReplyToCommentParams extends Equatable {
  ...
  const ReplyToCommentParams({required this.commentId, required this.content});
