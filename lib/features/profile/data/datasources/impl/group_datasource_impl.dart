      ...
      final apiResponse = ApiResponse<List<GroupModel>>(
        data: [
          GroupModel(
            ...
            description:
                'A group for UIT students to share study materials and tips.',
            avatarUrl:
                'https://storage.googleapis.com/pod_public/1300/138234.jpg',
          ),
          GroupModel(
            id: '2',
            name: 'UIT Sports Club',
            description:
                'A group for UIT students interested in sports and fitness activities.',
            avatarUrl:
                'https://storage.googleapis.com/pod_public/1300/138234.jpg',
          ),
          GroupModel(
            ...
            description:
                'A group for UIT students passionate about technology and programming.',
            avatarUrl:
                'https://storage.googleapis.com/pod_public/1300/138234.jpg',
          ),
        ],
