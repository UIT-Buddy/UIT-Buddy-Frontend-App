...
class GetAcademicDetailsUsecase implements UseCase<AcademicDetailEntity, NoParams> {
  GetAcademicDetailsUsecase({required AcademicDetailRepository academicDetailRepository}) : _academicDetailRepository = academicDetailRepository;
