...
class SearchSharedDocumentsUsecase
    implements UseCase<List<FileEntity>, SearchDocumentsParams> {
  SearchSharedDocumentsUsecase({required StorageRepository storageRepository})
    : _storageRepository = storageRepository;
  final StorageRepository _storageRepository;
  @override
  Future<Either<Failure, List<FileEntity>>> call(
    SearchDocumentsParams params,
  ) async => _storageRepository.searchSharedDocuments(
    page: params.page,
    limit: params.limit,
